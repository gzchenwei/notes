...
每个分片包含了多个"段",一个段就是一个倒排索引,查询分片,会轮流查询分片内部的段,
...
```
curl -XPUT http://localhost:9200/_template/da-logs -d '{
"template": "da-*",
"order": 1,
"settings": {
"number_of_shards": 2,
...
curl -XPUT http://localhost:9200/_template/udsvr_logs -d '{
"template": "udsvr*",
"order": 1,
"settings": {
"number_of_shards": 8,
...
curl -XPUT http://localhost:9200/_template/pop3svr_logs -d '{
"template": "pop3svr*",
"order": 1,
"settings": {
"number_of_shards": 4,
...
curl -XPUT http://localhost:9200/_template/mttrans_logs -d '{
"template": "mtatrans_*",
"order": 1,
"settings": {
"number_of_shards": 16,
...
curl -XPUT http://localhost:9200/_template/mta_trans-logs -d '{
"template": "mta_trans-*",
"order": 1,
"settings": {
"number_of_shards": 4,
